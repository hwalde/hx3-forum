...
class PtIssueAlias extends TableAlias {
    ...
    {
        return new ColumnField('pt_issue', 'issueid', $this->getAliasName());
    }
    public function projectId() : ColumnField
    {
        return new ColumnField('pt_issue', 'projectid', $this->getAliasName());
    }
    public function issueStatusId() : ColumnField
    {
        return new ColumnField('pt_issue', 'issuestatusid', $this->getAliasName());
    }
    public function issueTypeId() : ColumnField
    {
        return new ColumnField('pt_issue', 'issuetypeid', $this->getAliasName());
    }
    public function title() : ColumnField
    {
        return new ColumnField('pt_issue', 'title', $this->getAliasName());
    }
    public function summary() : ColumnField
    {
        return new ColumnField('pt_issue', 'summary', $this->getAliasName());
    }
    public function submitUserId() : ColumnField
    {
        return new ColumnField('pt_issue', 'submituserid', $this->getAliasName());
    }
    public function submitUserName() : ColumnField
    {
        return new ColumnField('pt_issue', 'submitusername', $this->getAliasName());
    }
    public function submitDate() : ColumnField
    {
        return new ColumnField('pt_issue', 'submitdate', $this->getAliasName());
    }
    public function appliesVersionId() : ColumnField
    {
        return new ColumnField('pt_issue', 'appliesversionid', $this->getAliasName());
    }
    public function isAddressed() : ColumnField
    {
        return new ColumnField('pt_issue', 'isaddressed', $this->getAliasName());
    }
    public function addressedVersionId() : ColumnField
    {
        return new ColumnField('pt_issue', 'addressedversionid', $this->getAliasName());
    }
    public function priority() : ColumnField
    {
        return new ColumnField('pt_issue', 'priority', $this->getAliasName());
    }
    public function visible() : ColumnField
    {
        return new ColumnField('pt_issue', 'visible', $this->getAliasName());
    }
    public function lastPost() : ColumnField
    {
        return new ColumnField('pt_issue', 'lastpost', $this->getAliasName());
    }
    public function lastActivity() : ColumnField
    {
        return new ColumnField('pt_issue', 'lastactivity', $this->getAliasName());
    }
    public function lastPostUserId() : ColumnField
    {
        return new ColumnField('pt_issue', 'lastpostuserid', $this->getAliasName());
    }
    public function lastPostUserName() : ColumnField
    {
        return new ColumnField('pt_issue', 'lastpostusername', $this->getAliasName());
    }
    public function firstNoteId() : ColumnField
    {
        return new ColumnField('pt_issue', 'firstnoteid', $this->getAliasName());
    }
    public function lastNoteId() : ColumnField
    {
        return new ColumnField('pt_issue', 'lastnoteid', $this->getAliasName());
    }
    public function attachCount() : ColumnField
    {
        return new ColumnField('pt_issue', 'attachcount', $this->getAliasName());
    }
    public function pendingPetitions() : ColumnField
    {
        return new ColumnField('pt_issue', 'pendingpetitions', $this->getAliasName());
    }
    public function replyCount() : ColumnField
    {
        return new ColumnField('pt_issue', 'replycount', $this->getAliasName());
    }
    public function votePositive() : ColumnField
    {
        return new ColumnField('pt_issue', 'votepositive', $this->getAliasName());
    }
    public function voteNegative() : ColumnField
    {
        return new ColumnField('pt_issue', 'votenegative', $this->getAliasName());
    }
    public function projectCategoryId() : ColumnField
    {
        return new ColumnField('pt_issue', 'projectcategoryid', $this->getAliasName());
    }
    public function assignedUsers() : ColumnField
    {
        return new ColumnField('pt_issue', 'assignedusers', $this->getAliasName());
    }
